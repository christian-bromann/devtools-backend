...
const host = document.currentScript.getAttribute('data-ws-host')
const remoteDebugger = window.remoteDebugger = new RemoteDebugger(uuid, host)
...
if (document.readyState === 'complete') {
    ...
    window.onload = remoteDebugger.loadHandler.bind(remoteDebugger, onload)
}
