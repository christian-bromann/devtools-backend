    ...
    proxyFilter (req, proxyRes, next) {
        ...
        request.head(req.target).then((headers) => {
            ...
            if (contentType &&
                ...
                /**
                 * don't treat time sync requests as pages
                 */
                (contentLength && parseInt(contentLength, 10)) &&
                /**
                 * ignore when server wants to close connection
                 */
                (connection && connection.match(/keep-alive/i)) &&
                /**
             ...
             */
            console.log(!req.retry, Boolean(this.page), this.page.url.host);
